namespace :latest_search_logs do
  ...
  task update: :environment do
    ...
    ActiveRecord::Base.connection.execute("insert into latest_search_logs select * from search_logs where created_at BETWEEN '#{start_time}' AND '#{end_time}' and device_type != 'crawler'")
  end
end
