  ...
  describe '#perform' do
    ...
    context 'The worker implements #unique_key' do
      ...
      it do
        ...
        middleware.perform(worker, args, history) {}
      end
      ...
      context '#perform_unique_check returns true' do
        ...
        it { expect { |b| middleware.perform(worker, args, history, &b) }.to yield_control }
      end
      ...
      context '#perform_unique_check returns false' do
        ...
        it { expect { |b| middleware.perform(worker, args, history, &b) }.not_to yield_control }
      end
    end
    ...
    context "The worker doesn't implement #unique_key" do
      ...
      it do
        ...
        expect { |b| middleware.perform(worker, args, history, &b) }.to yield_control
      end
    end
  end
