...
RSpec.describe TimelinesController, type: :controller do
  describe 'GET #show' do
    ...
    it 'receives all before_action callbacks' do
      ...
      expect(controller).to receive(:not_found_twitter_user?).with(screen_name).and_return(false)
      expect(controller).to receive(:forbidden_twitter_user?).with(screen_name).and_return(false)
