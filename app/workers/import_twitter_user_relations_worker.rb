class ImportTwitterUserRelationsWorker
  ...
  def perform(user_id, uid, options = {})
    ...
    uids = import_favorite_and_close_friendships(client, twitter_user, login_user: User.find_by(id: user_id))
    ImportTwitterDbS3UsersWorker.perform_async(uids, user_id: user_id)
