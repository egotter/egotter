  ...
  def notify(login_user, tu)
    ...
    unless login_user.id == searched_user.id
      ...
      CreateNotificationMessageWorker.perform_async(
        ...
        uid:         tu.uid,
        screen_name: tu.screen_name,
        headings:    {en: I18n.t('onesignal.searchNotification.title', user: tu.mention_name, locale: :en), ja: I18n.t('onesignal.searchNotification.title', user: tu.mention_name, locale: :ja)},
        contents:    {en: I18n.t('onesignal.searchNotification.message', url: url, locale: :en), ja: I18n.t('onesignal.searchNotification.message', url: url, locale: :ja)},
        medium:      'onesignal'
      )
    end
  rescue => e
