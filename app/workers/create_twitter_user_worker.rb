class CreateTwitterUserWorker
  ...
  def perform(values = {})
    ...
    begin
      ...
      ImportTwitterDbS3UsersWorker.perform_async(twitter_user.instance_variable_get(:@friend_uids), user_id: user_id)
      ImportTwitterDbS3UsersWorker.perform_async(twitter_user.instance_variable_get(:@follower_uids), user_id: user_id)
