module FunctionsSectionHelper
  def function_one_sided_friends_values
    ...
    {
        path: one_sided_friends_top_path(via: current_via('functions_icon')),
  ...
  def function_unfriends_values
    ...
    {
        path: unfriends_top_path(via: current_via('functions_icon')),
  ...
  def function_inactive_friends_values
    ...
    {
        path: inactive_friends_top_path(via: current_via('functions_icon')),
  ...
  def function_friends_values
    ...
    {
        path: friends_top_path(via: current_via('functions_icon')),
  ...
  def function_clusters_values
    ...
    {
        path: clusters_top_path(via: current_via('functions_icon')),
  ...
  def function_tokimeki_unfollow_values
    ...
    {
        path: tokimeki_unfollow_top_path(via: current_via('functions_icon')),
