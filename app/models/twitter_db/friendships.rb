module TwitterDB
  class Friendships
    def self.import(user_uid, friend_uids, follower_uids)
      ...
      TwitterDB::Friendship.delete_all(user_uid: user_uid) if TwitterDB::Friendship.exists?(user_uid: user_uid)
      TwitterDB::Friendship.import(%i(user_uid friend_uid sequence), friendships, validate: false, timestamps: false)

      TwitterDB::Followership.delete_all(user_uid: user_uid) if TwitterDB::Followership.exists?(user_uid: user_uid)
