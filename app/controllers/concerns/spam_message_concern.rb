module SpamMessageConcern
  ...
  class SpamMessageProcessor
    ...
    def received_regexp
      /死ね|殺す|黙れ|馬鹿|役立たず|無能|やくたたず|きいてんのか|いいかげんに|うるせーよ|うるせ[えぇ]|うっせえ|気持ち悪い|キモい|きもい|きしょい|うるせえよ|うるさい|(^(しね|くず|うざ|くそ|ころす|きえろ|ばか|だまれ|かえれ|こら|おい|きも|ごみ|ゴミ|ちんぽ|ちんこ|まんこ|うんち|うんこ)$)/
    end
