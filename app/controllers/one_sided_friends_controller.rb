class OneSidedFriendsController < ::Page::Base
  ...
  def all
    ...
    @collection = @twitter_user.one_sided_friends.limit(300)
  ...
  def tabs
    [
      {text: t('one_sided_friends.show.see_one_sided_friends_html', num: @twitter_user.one_sided_friendships.size), url: one_sided_friend_path(@twitter_user, via: build_via('tab'))},
      {text: t('one_sided_friends.show.see_one_sided_followers_html', num: @twitter_user.one_sided_followerships.size), url: one_sided_follower_path(@twitter_user, via: build_via('tab'))},
      {text: t('one_sided_friends.show.see_mutual_friends_html', num: @twitter_user.mutual_friendships.size), url: mutual_friend_path(@twitter_user, via: build_via('tab'))}
    ]
  end
end
